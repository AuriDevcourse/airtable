...
// because "/" being one specific speaker feed left twenty other pages reachable only from a
// dropdown. The feed itself did not move: this still reads /api/speakers, and the embed snippet
// this page copies is unchanged.
const PAGE_SIZE = 20;
