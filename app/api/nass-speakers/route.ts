...
import { fetchNass, NassError } from "@/lib/nass";
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const status = err instanceof NassError ? err.status : 500;
    const message = err instanceof NassError ? err.message : "Something went wrong loading NASS people.";
