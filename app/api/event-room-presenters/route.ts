...
import { fetchEventRoomPresenters, EventRoomsError } from "@/lib/eventrooms";
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const status = err instanceof EventRoomsError ? err.status : 500;
    const message =
      err instanceof EventRoomsError
        ? err.message
        : "Something went wrong loading event room presenters.";
